...
const compressorHouse = require("../../models/compressor_houses");
...
router.get("/alldatacompressor_house", (req, res) => 
   
compressorHouse.findAll()
    .then(compressor_house => {
      subQuery: false,
      res.render('gigs', {
        gigs:compressor_house
      })
      //console.log(stores);
      //res.send(stores);
    //res.sendStatus(200);
