...
const engineHouse33 = require("../../models/engine_house_unit_33s");
...
router.get("/alldataengine_house_unit_33", (req, res) => 
   
engineHouse33.findAll()
    .then(engine_house_unit_33 => {
      res.render('gigs', {
        gigs:engine_house_unit_33
      })
      //console.log(stores);
      //res.send(stores);
    //res.sendStatus(200);
